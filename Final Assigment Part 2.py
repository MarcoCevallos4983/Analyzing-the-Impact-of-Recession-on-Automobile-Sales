...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        rec_data = recession_data[['unemployment_rate','Automobile_Sales','Vehicle_Type']]
        R_chart4 = dcc.Graph(figure =px.bar(rec_data,x='unemployment_rate',y='Automobile_Sales',
        color = 'Vehicle_Type', title =
        'Automobile_Sales based on unemployment ratio'))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        title = 'Automovile Sales over Years'))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(yearly_data, x = 'Month',y= 'Automobile_Sales',
        title = 'Automovile Sales over Months {}'.format(input_year)))
        ...
        names = 'Vehicle_Type' ,
        title='Average Advertising Expenditure Sold by Vehicle Type in the year {}'.format(input_year)))

#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart_item', children=[html.Div(Y_chart1),html.Div(Y_chart2)],style={'display': 'flex'}),
